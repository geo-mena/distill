  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, padding: "24px 0", flexWrap: "nowrap" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
        <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a", textAlign: "center", maxWidth: 100 }}>
      ...
      <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a" }}>input</div>
      ...
      <Arrow length={50} />
      <TensorVector cells={5} color="salmon" />
      <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a" }}>output</div>
    </div>
  );
}
  ...
  return (
    <div style={{ position: "relative", padding: "20px 0" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginBottom: 28 }}>
        <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a", maxWidth: 110, textAlign: "right", fontWeight: 600 }}>
          conditioning<br/>representation
        </div>
        <Arrow length={50} />
        ...
        <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a", maxWidth: 220, marginLeft: 12 }}>
  ...
  return (
    <div style={{ display: "flex", alignItems: "stretch", justifyContent: "center", gap: 60, padding: "20px 0" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", maxWidth: 280 }}>
        <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a", lineHeight: 1.5, marginBottom: 24, textAlign: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a" }}>conditioning</div>
          <Arrow length={40} />
          <div style={{
            background: "#a8c8e8", border: "1px solid #356aa8", borderRadius: 4,
            padding: "32px 24px", fontFamily: "var(--font-sans)", fontSize: 14, color: "#2a2a2a", fontWeight: 500
          }}>FiLM generator</div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, maxWidth: 240 }}>
        ...
        <div style={{ width: 180, padding: "14px 18px", background: "#fdecea", border: "1px solid #f5a39b", borderRadius: 4, fontFamily: "var(--font-sans)", fontSize: 13, color: "#9a9a98", textAlign: "center" }}>sub-network</div>
        <div style={{ width: 1, height: 8, background: "#888" }} />
        <div style={{ width: 180, padding: "10px 18px", background: "#fbd9d4", border: "1px solid #f5a39b", borderRadius: 4, fontFamily: "var(--font-sans)", fontSize: 13, color: "#2a2a2a", textAlign: "center", fontWeight: 600 }}>FiLM</div>
        <div style={{ width: 1, height: 8, background: "#888" }} />
        <div style={{ width: 180, padding: "14px 18px", background: "#fdecea", border: "1px solid #f5a39b", borderRadius: 4, fontFamily: "var(--font-sans)", fontSize: 13, color: "#9a9a98", textAlign: "center" }}>sub-network</div>
        <div style={{ width: 1, height: 8, background: "#888" }} />
        <div style={{ width: 180, padding: "10px 18px", background: "#fbd9d4", border: "1px solid #f5a39b", borderRadius: 4, fontFamily: "var(--font-sans)", fontSize: 13, color: "#2a2a2a", textAlign: "center", fontWeight: 600 }}>FiLM</div>
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 36, padding: "32px 0" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "stretch", gap: 22, minWidth: 260 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, fontFamily: "var(--font-sans)", fontSize: 13, color: "#4a4a4a", marginBottom: 6 }}>
        ...
        <div style={{ fontFamily: "var(--font-sans)", fontStyle: "italic", fontSize: 14, color: "#6a6a6a", lineHeight: 1.5 }}>
