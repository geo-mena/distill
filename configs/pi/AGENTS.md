...
For Pi, prefer `pi install git:github.com/geo-mena/distill` or install a local checkout with `pi install ./distill`. The package metadata points to `./plugins/distill-design` for the skill.
